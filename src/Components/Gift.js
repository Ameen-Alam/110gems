...
/* Gift FOr Her */
/* Gift FOr Him */
import B1 from '../Images/Gifts/ForHim/1.jpg';
import B2 from '../Images/Gifts/ForHim/2.jpg';
import B3 from '../Images/Gifts/ForHim/3.jpg';
import B4 from '../Images/Gifts/ForHim/4.jpg';
import B5 from '../Images/Gifts/ForHim/5.jpg';
import B6 from '../Images/Gifts/ForHim/6.jpg';
import B7 from '../Images/Gifts/ForHim/7.jpg';
import B8 from '../Images/Gifts/ForHim/8.jpg';
import B9 from '../Images/Gifts/ForHim/9.jpg';
import B10 from '../Images/Gifts/ForHim/10.jpg';
import B11 from '../Images/Gifts/ForHim/11.jpg';
import B12 from '../Images/Gifts/ForHim/12.jpg';
import B13 from '../Images/Gifts/ForHim/13.jpg';
import B14 from '../Images/Gifts/ForHim/14.jpg';
/* Gift FOr Him */
/* Wedding */
        ...
        return (
            <div className="container-fluid padding-2">
                ...
                <div className="" style={{ borderBottom: '1px solid #222' }} >
                    <h2 className="pt-3 text-muted pl-3 pl-lg-0" > Gifts For Her (31)</h2>
                    <br />
                </div>
                ...
                {/* Gifts For HIM */}
                <div className="" style={{ borderBottom: '1px solid #222' }} >
                    <h2 className="pt-3 text-muted pl-3 pl-lg-0" > Gifts For Him (14)</h2>
                    <br />
                </div>
                <div className="mt-3 px-0 " >
                    {/* <div className="col-md-3 col-sm-4 col-xs-6" > */}
                ...
                {/* Wedding Gifts */}
                <div className="" style={{ borderBottom: '1px solid #222' }} >
                    <h2 className="pt-3 text-muted pl-3 pl-lg-0" > Wedding Gifts (0)</h2>
                    <br />
                </div>
                <div className="mt-3 px-0 " >
                </div>
