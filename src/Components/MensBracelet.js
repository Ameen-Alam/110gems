...
import "./Comp.css"
//Images
import A1 from '../Images/jewelry/MensBracelete/1.jpg';
import A2 from '../Images/jewelry/MensBracelete/2.jpg';
import A3 from '../Images/jewelry/MensBracelete/3.jpg';
import A4 from '../Images/jewelry/MensBracelete/4.png';
import A5 from '../Images/jewelry/MensBracelete/5.jpg';
import A6 from '../Images/jewelry/MensBracelete/6.jpg';
import A7 from '../Images/jewelry/MensBracelete/7.jpg';
import A8 from '../Images/jewelry/MensBracelete/8.jpg';
import A9 from '../Images/jewelry/MensBracelete/9.jpg';
import A10 from '../Images/jewelry/MensBracelete/10.jpg';

class MensBracelet extends Component {
    constructor(props) {
        super(props)
        ...
        return (
            <div className="container-fluid padding-2">
                <div className="" style={{ borderBottom: '1px solid #222' }} >
                    <h2 className="pt-3 text-muted pl-3 pl-lg-0" > Most Popular (10)</h2>
                    <br />
                </div>
